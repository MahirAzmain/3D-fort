...
public:
    ...
    void drawCurve(Shader& lightingShaderWithTexture, glm::mat4 model = glm::mat4(1.0f))
    {
        lightingShaderWithTexture.use();
...
private:
    ...
    void setUpCubeVertexDataAndConfigureVertexAttribute()
    {
        ...
        float cube_vertices[] = {
            ...
            // back
            -1.0f, -1.0f, -1.0f, 0.0f, 0.0f, -1.0f, TXmax, TYmin,
            1.0f, -1.0f, -1.0f, 0.0f, 0.0f, -1.0f, TXmin, TYmin,
            1.0f, 1.0f, -1.0f, 0.0f, 0.0f, -1.0f, TXmin, TYmax,
            -1.0f, 1.0f, -1.0f, 0.0f, 0.0f, -1.0f, TXmax, TYmax,

            // right
            1.0f, -1.0f, -1.0f, 1.0f, 0.0f, 0.0f, TXmax, TYmin,
            1.0f, 1.0f, -1.0f, 1.0f, 0.0f, 0.0f, TXmax, TYmax,
            1.0f, -1.0f, 1.0f, 1.0f, 0.0f, 0.0f, TXmin, TYmin,
            1.0f, 1.0f, 1.0f, 1.0f, 0.0f, 0.0f, TXmin, TYmax,

            // front
            -1.0f, -1.0f, 0.5f, 0.0f, 0.0f, 1.0f, TXmin, TYmin,
